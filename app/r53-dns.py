    ...
    try:
        ...
        for account in accounts:
            ...
            if account_id != LAMBDA_ACCOUNT_ID:
                ...
                process_account(account_id, lambda_security_audit_role)
...
def process_account(account_id, security_audit_role):
    ...
    try:
        ...
        # Process Route 53 records (global)
        process_route53_records(writer, account_id, route53)

        # Process Load Balancers for each region
        for region in regions:
            Logger.info(f"Processing region {region} in account {account_id}")
            try:
                elbv2 = session.client('elbv2', region_name=region)
                process_load_balancers(writer, account_id, region, elbv2)
            except ClientError as e:
...
def process_route53_records(writer, account_id, route53):
    ...
    for page in paginator.paginate():
        for zone in page['HostedZones']:
            ...
            for record in records['ResourceRecordSets']:
                process_record(writer, account_id, 'Global', record, zone_id, zone_type)

def process_load_balancers(writer, account_id, region, elbv2):
    ...
    for elb in elbs:
        ...
        for listener in listeners:
            ...
            if tg_arn:
                ...
                writer.writerow([
                    account_id, region, 'N/A', 'N/A', lb_dns_name, 'Yes', 'N/A', 'N/A', 'N/A', 'N/A',
                    lb_arn, lb_dns_name, listener_arn, listener_port, tg_name,
                    tls_enabled, health_check_enabled, health_check_protocol, health_check_port, health_check_path
                ])

def process_record(writer, account_id, region, record, zone_id, zone_type):
    ...
    writer.writerow([
        ...
        zone_type, zone_id, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A'
    ])
